...
namespace MTech.LLBLGen.Entities.EntityClasses
{
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		protected class CowEntityStaticMetaData : AnimalEntityStaticMetaData
		{
			...
			{
				SetEntityCoreInfo("CowEntity", InheritanceHierarchyType.TargetPerEntity, true, (int)MTech.LLBLGen.Entities.EntityType.CowEntity, typeof(CowEntity), typeof(CowEntityFactory), false);
			}
		}
